...
oauthSignIn = () => {
  window.open(
    `https://accounts.google.com/o/oauth2/auth?scope=https://www.googleapis.com/auth/drive&redirect_uri=sphynxinatorx.github.io/freefoil-dev&response_type=code&client_id=${clientID}`,
    "popup",
...
getAuth = () => {
  ...
  urlencoded.append("redirect_uri", "sphynxinatorx.github.io/freefoil-dev");
